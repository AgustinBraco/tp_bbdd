...
reservas
INNER JOIN 
administradores ON reservas.id_administrador = administradores.id_administrador
INNER JOIN 
estadoReserva ON reservas.id_estadoReserva = estadoReserva.id_estadoReserva
WHERE 
estadoReserva.estadoReserva = 'Abonada'
ORDER BY 
Fecha, Horario;